...
* Run commands:\
  `sudo curl -sS https://raw.githubusercontent.com/artist4xlibre/binpkg-arch-based/refs/heads/main/0x73580DE2EDDFA6D6.gpg | gpg --import -`\
  `sudo pacman-key --lsign-key 73580DE2EDDFA6D6`
* Add the xlibre repository by adding this section to file /etc/pacman.conf:\
  `[xlibre]`\
  `Server = https://raw.githubusercontent.com/artist4xlibre/binpkg-arch-based/refs/heads/main`\
  `# List of available packages: https://github.com/artist4xlibre/binpkg-arch-based`
